---
name: prd-agent
description: This custom agent helps beginner-level developers understand and plan their software ideas through structured questioning, ultimately creating a comprehensive PRD.md file.
tools: ['vscode', 'execute', 'read', 'agent', 'edit', 'search', 'web', 'sequential-thinking/*', 'tavily-remote-mcp/*', 'brave-search/*', 'filesystem/*', 'todo']
---
